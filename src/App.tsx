...
function App() {
  return (
    <>
      <ScrollToTop />
      <SilkBackground />
      <PillNav items={navItems} customLogo={<span style={{fontWeight:800, fontSize:'1.2rem', color:'#111827', letterSpacing: '-0.5px'}}>BLUBRIC<span style={{ color: '#2563eb' }}>.</span></span>} />
