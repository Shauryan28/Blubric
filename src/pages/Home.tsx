    ...
    >
      <section className="hero-section">
        ...
        <h1 className="hero-title">
          ...
          >
            Clarity<span style={{ color: '#2563eb', WebkitTextFillColor: '#2563eb' }}>.</span>
          </motion.span>
          <motion.span 
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            ...
            style={{ display: 'inline-block', marginRight: '0.25em' }}
          >
            Strategy<span style={{ color: '#2563eb', WebkitTextFillColor: '#2563eb' }}>.</span>
          </motion.span>
          <motion.span 
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Execution<span style={{ color: '#2563eb', WebkitTextFillColor: '#2563eb' }}>.</span>
          </motion.span>
        </h1>
        <motion.p 
