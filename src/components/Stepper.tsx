    ...
    <motion.div onClick={handleClick} className="step-indicator" animate={status} initial={false}>
      <motion.div
        variants={{
          ...
          active: { scale: 1, backgroundColor: 'var(--accent-color)', color: '#030305' },
          complete: { scale: 1, backgroundColor: 'rgba(255,255,255,0.1)', color: 'var(--text-primary)' }
        }}
...
function StepConnector({ isComplete }: StepConnectorProps) {
  const lineVariants: Variants = {
    ...
    complete: { width: '100%', backgroundColor: 'var(--accent-color)' }
  };
